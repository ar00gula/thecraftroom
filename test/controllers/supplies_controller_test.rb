...
class SuppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post supplies_url, params: { supply: { description: @supply.description, name: @supply.name } }
    end
  ...
  test "should update supply" do
    patch supply_url(@supply), params: { supply: { description: @supply.description, name: @supply.name } }
