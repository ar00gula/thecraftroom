...
class CraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create craft" do
    assert_difference('Craft.count') do
      post crafts_url, params: { craft: { description: @craft.description, name: @craft.name } }
    end
  ...
  test "should update craft" do
    patch craft_url(@craft), params: { craft: { description: @craft.description, name: @craft.name } }
